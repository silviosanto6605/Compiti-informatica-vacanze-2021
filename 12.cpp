...
int main(){
    ...
    for(int i=0; i<nAltezze; i++){                /* Cicla l'array per inserire tutte le altezze */ 
    ...
    for(int j= 0; j<nAltezze; j++){          /* Cicla l'array per controllare le altezze che soddisfano le condizioni*/
